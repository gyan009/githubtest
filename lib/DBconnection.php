...
class DBconnection {
    ...
    * *******************/
    ...
    function DBconnection($hostname=false, $username=false, $password=false, $database=false){
	/*self::$this->database = $database;
	self::$this->username = $username;
	self::$this->password = $password;
	self::$this->hostname = $hostname;*/
	self::$this->database = DB_NAME;
	self::$this->username = DB_USER;
	self::$this->password = DB_PASS;
	self::$this->hostname = DB_HOST;
	$this->Connect();
    }
